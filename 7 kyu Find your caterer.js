...
function findCaterer(budget, people){
  ...
  var budgetPerPerson = budget/people;

  if (budgetPerPerson >= 30 || people > 60 && budgetPerPerson > 24) {
    return 3;
  }
  else if (budgetPerPerson >= 20 && budgetPerPerson < 30) {
    return 2;
  }
  else if (budgetPerPerson >= 15 && budgetPerPerson< 20) {
    return 1;
  }
  else { 
    return -1;
